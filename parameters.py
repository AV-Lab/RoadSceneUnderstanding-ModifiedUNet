...
TRAIN_MASK_IMG_DIR 		= os.path.dirname(os.getcwd()) + "\\data\\training\\v2.0\\labels\\"
TRAIN_MASK_VEHICLE_DIR 	= os.path.dirname(os.getcwd()) + "\\data\\training\\v2.0\\labels_vehicle\\"
