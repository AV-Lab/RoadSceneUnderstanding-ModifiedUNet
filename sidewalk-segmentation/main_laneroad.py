...
train_loader = getDatasetLoader(
	...
	dir_mask    = [TRAIN_MASK_LANELINE_DIR, TRAIN_MASK_ROAD_DIR],
...
validation_loader  = getDatasetLoader(
	...
	dir_mask    = [VAL_MASK_LANELINE_DIR, VAL_MASK_ROAD_DIR],
...
for epoch in range(NUM_EPOCHS):
	...
	if prev > loss_total/len(validation_loader):
		saveParameters(model = model, optimizer = optimizer, name= "laneroad_model")
